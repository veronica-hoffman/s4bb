...
for band in "${bands[@]}"; do
    # +0.5% bias
    /usr/bin/time -v python -u phase2_mlsearch.py 1 20 --pbs --bias-band="${band}" --bias-percent=0.5 --noffdiag=0 \
        &> jobs/ph2_mlsearch_f2_y20_n3_diag0_full_nopbs_${band}_+0.5pct.out &
